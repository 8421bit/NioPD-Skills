...
9. [NioPD Ultra SOTA Extras](#niopd-ultra-sota-extras)
...
## NioPD Ultra SOTA Extras

### 1. Global Configuration (Directives)
Use this snippet at the top of diagrams to enforce NioPD's professional theme.
...
### 2. C4 System Context Pattern (Architecture)
Use this for high-level system diagrams.

```mermaid
graph TB
    subgraph context["System Context: [System Name]"]
        Customer((Customer))
...
- **Click Events**: `click NodeID call callback() "Tooltip"`
- **Links**: `click NodeID href "https://google.com"`
